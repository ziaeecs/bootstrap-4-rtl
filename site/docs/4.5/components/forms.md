...
<div class="input-group">
  ...
  <input type="text" class="form-control rounded-left" required>
  <div class="invalid-feedback">
...
<div class="bd-example bd-example-forms-input-group-workaround">
  <div class="input-group">
    ...
    <input type="text" class="form-control is-invalid rounded-left" required>
    <div class="invalid-feedback">
      Please choose a username.
    </div>
  </div>
...
<div class="input-group input-group-sm">
  ...
  <input type="text" class="form-control fix-rounded-left" required>
  <div class="invalid-feedback">
    Please choose a username.
  </div>
</div>
...
<div class="bd-example bd-example-forms-input-group-workaround">
  <div class="input-group input-group-sm">
    ...
    <input type="text" class="form-control is-invalid fix-rounded-left" required>
    <div class="invalid-feedback">
      Please choose a username.
    </div>
  </div>
